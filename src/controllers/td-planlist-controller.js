...
exports.Show_action = async (req, res, next) => {
  ...
  try {
    const selectOrder = await prisma.tD_Order.findMany({
      where: {
        Plan: {
          some: {
            Pt_Delivery: {
            ...
            AND: [
                ...
                OR: [
                  {
                    Parts_No: S_St_Parts_No
                      ? parseInt(S_St_Parts_No)
                      : undefined,
                  },
                  {
                    Parts_No: {
                      gte: S_St_Parts_No ? String(S_St_Parts_No) : "0",
                      lte: S_Ed_Parts_No ? String(S_Ed_Parts_No) : "99",
                    },
                  },
                ],
              },
              ...
              {
                OR: [
                  { Pt_Qty: S_St_Pt_Qty ? parseInt(S_St_Pt_Qty) : 0 },
                  {
                    Pt_Qty: {
                      gte: S_St_Pt_Qty ? parseInt(S_St_Pt_Qty) : 0,
                      lte: S_Ed_Pt_Qty ? parseInt(S_Ed_Pt_Qty) : 999999,
                    },
                  },
                ],
              },
              // Pt_Spare_Qty Filter
              {
                OR: [
                  {
                    Pt_Spare_Qty: S_St_Pt_Sp_Qty ? parseInt(S_St_Pt_Sp_Qty) : 0,
                  },
                  {
                    Pt_Spare_Qty: {
                      gte: S_St_Pt_Sp_Qty ? parseInt(S_St_Pt_Sp_Qty) : 0,
                      lte: S_Ed_Pt_Sp_Qty ? parseInt(S_Ed_Pt_Sp_Qty) : 999999,
                    },
                  },
                ],
              },
              ...
              {
                OR: [
                  { Pt_NG_Qty: S_St_Pt_NG_Qty ? parseInt(S_St_Pt_NG_Qty) : 0 },
                  {
                    Pt_NG_Qty: {
                      gte: S_St_Pt_NG_Qty ? parseInt(S_St_Pt_NG_Qty) : 0,
                      lte: S_Ed_Pt_NG_Qty ? parseInt(S_Ed_Pt_NG_Qty) : 999999,
                    },
                  },
                ],
              },
              ...
              { NAV_Delivery: S_St_NAV_Delivery || undefined || null },
              {
                NAV_Delivery: {
                  gte: S_St_NAV_Delivery
                    ? new Date(S_St_NAV_Delivery)
                    : new Date("0000-01-01"),
                  lte: S_Ed_NAV_Delivery
                    ? new Date(S_Ed_NAV_Delivery)
                    : new Date("9999-12-31"),
                },
              },
            ],
              ...
              { Confirm_Delivery: S_St_Confirm_Delivery || undefined || null },
              {
                Confirm_Delivery: {
                  gte: S_St_Confirm_Delivery
                    ? new Date(S_St_Confirm_Delivery)
                    : new Date("0000-01-01"),
                  lte: S_Ed_Confirm_Delivery
                    ? new Date(S_Ed_Confirm_Delivery)
                    : new Date("9999-12-31"),
                },
              },
            ],
              ...
              { Product_Delivery: S_St_Product_Delivery || undefined || null },
              {
                Product_Delivery: {
                  gte: S_St_Product_Delivery
                    ? new Date(S_St_Product_Delivery)
                    : new Date("0000-01-01"),
                  lte: S_Ed_Product_Delivery
                    ? new Date(S_Ed_Product_Delivery)
                    : new Date("9999-12-31"),
                },
              },
            ],
              ...
              { Pd_Received_Date: S_St_Product_Delivery || undefined || null },
              {
                Pd_Received_Date: {
                  gte: S_St_Pd_Received_Date
                    ? new Date(S_St_Pd_Received_Date)
                    : new Date("0000-01-01"),
                  lte: S_Ed_Pd_Received_Date
                    ? new Date(S_Ed_Pd_Received_Date)
                    : new Date("9999-12-31"),
                },
              },
            ],
              ...
              { Pd_Complete_Date: S_St_Pd_Complete_Date || undefined || null },
              {
                Pd_Complete_Date: {
                  gte: S_St_Pd_Complete_Date
                    ? new Date(S_St_Pd_Complete_Date)
                    : new Date("0000-01-01"),
                  lte: S_Ed_Pd_Complete_Date
                    ? new Date(S_Ed_Pd_Complete_Date)
                    : new Date("9999-12-31"),
                },
              },
            ],
              ...
              { I_Completed_Date: S_St_I_Complete_Date || undefined || null },
              {
                I_Completed_Date: {
                  gte: S_St_I_Complete_Date
                    ? new Date(S_St_I_Complete_Date)
                    : new Date("0000-01-01"),
                  lte: S_Ed_I_Complete_Date
                    ? new Date(S_Ed_I_Complete_Date)
                    : new Date("9999-12-31"),
                },
              },
            ],
              ...
              { Shipment_Date: S_St_Shipment_Date || undefined || null },
              {
                Shipment_Date: {
                  gte: S_St_Shipment_Date
                    ? new Date(S_St_Shipment_Date)
                    : new Date("0000-01-01"),
                  lte: S_Ed_Shipment_Date
                    ? new Date(S_Ed_Shipment_Date)
                    : new Date("9999-12-31"),
                },
              },
            ],
...

          {
            OR: [
              { Pd_Calc_Date: S_St_Calc_Date || undefined || null },
              {
                Pd_Calc_Date: {
                  gte: S_St_Calc_Date
                    ? new Date(S_St_Calc_Date)
                    : new Date("0000-01-01"),
                  lte: S_Ed_Calc_Date
                    ? new Date(S_Ed_Calc_Date)
                    : new Date("9999-12-31"),
                },
              },
            ],
